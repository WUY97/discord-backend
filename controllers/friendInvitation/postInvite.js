...
const postInvite = async (req, res) => {
    ...
    // check if the user that we would like to invite is already our friend
    ...
    // if invitation has been successfully created we would like to update friends invitation s
